...
namespace CreativeSpore.SmartColliders
{
	...
	public class Add1BodyCollider : MonoBehaviour
	{
		// Token: 0x06001ED0 RID: 7888 RVA: 0x00250000 File Offset: 0x0024E200
		private void Awake()
		{
			this.playerCtrl_Add1 = base.transform.parent.GetComponent<PlayerController_Add1>();
		...
		// Token: 0x06001ED1 RID: 7889 RVA: 0x0025004E File Offset: 0x0024E24E
		private void Start()
		{
			this.instantiateManager = this.playerCtrl_Add1.instantiateManager;
		}

		// Token: 0x06001ED2 RID: 7890 RVA: 0x00250064 File Offset: 0x0024E264
		private void OnTriggerStay2D(Collider2D other)
		{
			...
			if (this.myPV.isMine && !this.playerCtrl_Add1.damaged)
			{
				...
				if ((this.playerStatus.teamDamage || this.playerCtrl_Add1.miryou) && (other.tag == "PlayerATKArm" || other.tag == "PlayerATKChain" || other.tag == "PlayerATKMagic" || other.tag == "PlayerMagic" || other.tag == "PlayerATKHit" || other.tag == "PlayerATKCut" || other.tag == "PlayerATKPoke" || other.tag == "PlayerATKFire" || other.tag == "PlayerATKIce" || other.tag == "PlayerATKThunder" || other.tag == "PlayerATKStone" || other.tag == "PlayerATKLight" || other.tag == "PlayerATKDark" || other.tag == "PlayerATKPoison" || other.tag == "PlayerATKCurse" || other.tag == "PlayerATKKick" || other.tag == "PlayerATKSpinningKick" || other.tag == "PlayerATKSlidingKick" || other.tag == "PlayerATKTackle" || other.tag == "PlayerATKUpper"))
				{
					if (other.transform.root.tag == "Player" && other.transform.root != base.transform.root)
					{
						this.TeamDamage(other.gameObject);
						this.playerCtrl_Add1.HitEffect();
					}
				...
				if (other.tag == "EnemyBodyAttack" || other.tag == "EnemyBlockCollider")
				{
					...
					if (!this.playerCtrl_Add1.isSkelton)
					{
						if (this.playerCtrl_Add1.oldTypeArmor == 1)
						{
							float f = this.playerCtrl_Add1.hpMax / 5f;
							float f2 = Mathf.Round(f);
							int damage = Mathf.RoundToInt(f2);
							this.playerCtrl_Add1.ActionDamage(damage);
							this.playerCtrl_Add1.HitEffect();
						}
						else if (this.playerCtrl_Add1.oldTypeArmor == 0)
						{
							EnemyBody componentInParent = other.GetComponentInParent<EnemyBody>();
							float num = componentInParent.enemyATK / 1.5f;
							float num2 = this.playerCtrl_Add1.dEF / 10f;
							float f3 = num * this.playerCtrl_Add1.berserkerMeiru - num2;
							float f4 = Mathf.Round(f3);
							int num3 = Mathf.RoundToInt(f4);
							if (num3 >= 1)
							{
								this.playerCtrl_Add1.ActionDamage(num3);
								this.playerCtrl_Add1.HitEffect();
							}
							else if (num3 < 1)
							{
								this.playerCtrl_Add1.ActionDamage(1);
								this.playerCtrl_Add1.HitEffect();
							}
						}
					}
					else if (this.playerCtrl_Add1.isSkelton)
					{
						...
						if (num4 >= 1)
						{
							this.playerCtrl_Add1.ActionDamage(num4);
							this.playerCtrl_Add1.HitEffect();
						}
						else if (num4 < 1)
						{
				...
				else if (other.tag == "EnemyBodyAttackSp" || other.tag == "EnemyBodyAttackBoss01")
				{
					if (!this.playerCtrl_Add1.isSkelton)
					{
						if (this.playerCtrl_Add1.oldTypeArmor == 1)
						{
							float f7 = this.playerCtrl_Add1.hpMax / 5f;
							float f8 = Mathf.Round(f7);
							int damage2 = Mathf.RoundToInt(f8);
							this.playerCtrl_Add1.ActionDamage(damage2);
							this.playerCtrl_Add1.HitEffect();
						}
						else if (this.playerCtrl_Add1.oldTypeArmor == 0)
						{
							...
							float num6 = this.playerCtrl_Add1.dEF / 10f;
							float f9 = num5 * this.playerCtrl_Add1.berserkerMeiru - num6;
							float f10 = Mathf.Round(f9);
							int num7 = Mathf.RoundToInt(f10);
							if (num7 >= 1)
							{
								this.playerCtrl_Add1.ActionDamage(num7);
								this.playerCtrl_Add1.HitEffect();
							}
							else if (num7 < 1)
							{
					...
					else if (this.playerCtrl_Add1.isSkelton)
					{
						...
						if (num8 >= 1)
						{
							this.playerCtrl_Add1.ActionDamage(num8);
							this.playerCtrl_Add1.HitEffect();
						}
						else if (num8 < 1)
						{
				...
				else if (other.tag == "EnemyATKArm")
				{
					if (!this.playerCtrl_Add1.isSkelton)
					{
						if (this.playerCtrl_Add1.oldTypeArmor == 1)
						{
							float f13 = this.playerCtrl_Add1.hpMax / 5f;
							float f14 = Mathf.Round(f13);
							int damage3 = Mathf.RoundToInt(f14);
							this.playerCtrl_Add1.ActionDamage(damage3);
							this.playerCtrl_Add1.HitEffect();
							this.playerCtrl_Add1.BloodEffect();
						}
						else if (this.playerCtrl_Add1.oldTypeArmor == 0)
						{
							EnemyBody componentInParent5 = other.GetComponentInParent<EnemyBody>();
							float enemyATK = componentInParent5.enemyATK;
							float num9 = this.playerCtrl_Add1.dEF / 10f;
							float f15 = enemyATK * this.playerCtrl_Add1.berserkerMeiru - num9;
							float f16 = Mathf.Round(f15);
							int num10 = Mathf.RoundToInt(f16);
							if (num10 >= 1)
							{
								this.playerCtrl_Add1.ActionDamage(num10);
								this.playerCtrl_Add1.HitEffect();
								this.playerCtrl_Add1.BloodEffect();
							}
							else if (num10 < 1)
							{
								this.playerCtrl_Add1.ActionDamage(0);
								this.playerCtrl_Add1.HitEffect();
								this.playerCtrl_Add1.BloodEffect();
							}
						}
					...
					else if (this.playerCtrl_Add1.isSkelton)
					{
						...
						if (num11 >= 1)
						{
							this.playerCtrl_Add1.ActionDamage(num11);
							this.playerCtrl_Add1.HitEffect();
							this.playerCtrl_Add1.BloodEffect();
						}
						else if (num11 < 1)
				...
				else if (other.tag == "EnemyATKMagic")
				{
					if (!this.playerCtrl_Add1.isSkelton)
					{
						if (this.playerCtrl_Add1.oldTypeArmor == 1)
						{
							float f18 = this.playerCtrl_Add1.hpMax / 5f;
							float f19 = Mathf.Round(f18);
							int damage4 = Mathf.RoundToInt(f19);
							this.playerCtrl_Add1.ActionDamage(damage4);
							this.playerCtrl_Add1.HitEffect();
						}
						else if (this.playerCtrl_Add1.oldTypeArmor == 0)
						{
							...
							float num12 = this.playerCtrl_Add1.mND / 10f;
							float f20 = enemyINT * this.playerCtrl_Add1.berserkerMeiru - num12;
							float f21 = Mathf.Round(f20);
							int num13 = Mathf.RoundToInt(f21);
							if (num13 >= 1)
							{
								this.playerCtrl_Add1.ActionDamage(num13);
								this.playerCtrl_Add1.HitEffect();
							}
							else if (num13 < 1)
							{
					...
					else if (this.playerCtrl_Add1.isSkelton)
					{
						...
						if (num14 >= 1)
						{
							this.playerCtrl_Add1.ActionDamage(num14);
							this.playerCtrl_Add1.HitEffect();
						}
						else if (num14 < 1)
						{
				...
				else if (other.tag == "EnemyATKHit")
				{
					if (!this.playerCtrl_Add1.isSkelton)
					{
						if (this.playerCtrl_Add1.oldTypeArmor == 1)
						{
							float f23 = this.playerCtrl_Add1.hpMax / 5f;
							float f24 = Mathf.Round(f23);
							int damage5 = Mathf.RoundToInt(f24);
							this.playerCtrl_Add1.ActionDamage(damage5);
							this.playerCtrl_Add1.HitEffect();
						}
						else if (this.playerCtrl_Add1.oldTypeArmor == 0)
						{
							...
							float num15 = this.playerCtrl_Add1.dEF / 10f;
							float num16 = enemyATK3 / 100f * this.playerCtrl_Add1.playerHIT;
							float f25 = enemyATK3 * this.playerCtrl_Add1.berserkerMeiru - num16 - num15;
							float f26 = Mathf.Round(f25);
							int num17 = Mathf.RoundToInt(f26);
							if (num17 >= 1)
							{
								this.playerCtrl_Add1.ActionDamage(num17);
								this.playerCtrl_Add1.HitEffect();
							}
							else if (num17 < 1)
							{
					...
					else if (this.playerCtrl_Add1.isSkelton)
					{
						...
						if (num18 >= 1)
						{
							this.playerCtrl_Add1.ActionDamage(num18);
							this.playerCtrl_Add1.HitEffect();
						}
						else if (num18 < 1)
						{
				...
				else if (other.tag == "EnemyATKCut")
				{
					if (!this.playerCtrl_Add1.isSkelton)
					{
						if (this.playerCtrl_Add1.oldTypeArmor == 1)
						{
							float f28 = this.playerCtrl_Add1.hpMax / 5f;
							float f29 = Mathf.Round(f28);
							int damage6 = Mathf.RoundToInt(f29);
							this.playerCtrl_Add1.ActionDamage(damage6);
							this.playerCtrl_Add1.BloodEffect();
						}
						else if (this.playerCtrl_Add1.oldTypeArmor == 0)
						{
							...
							float num19 = this.playerCtrl_Add1.dEF / 10f;
							float num20 = enemyATK5 / 100f * this.playerCtrl_Add1.playerCUT;
							float f30 = enemyATK5 * this.playerCtrl_Add1.berserkerMeiru - num20 - num19;
							float f31 = Mathf.Round(f30);
							int num21 = Mathf.RoundToInt(f31);
							if (num21 >= 1)
							{
								this.playerCtrl_Add1.ActionDamage(num21);
								this.playerCtrl_Add1.BloodEffect();
							}
							else if (num21 < 1)
							{
					...
					else if (this.playerCtrl_Add1.isSkelton)
					{
						...
						if (num22 >= 1)
						{
							this.playerCtrl_Add1.ActionDamage(num22);
							this.playerCtrl_Add1.BloodEffect();
						}
						else if (num22 < 1)
						{
				...
				else if (other.tag == "EnemyATKPoke")
				{
					if (!this.playerCtrl_Add1.isSkelton)
					{
						if (this.playerCtrl_Add1.oldTypeArmor == 1)
						{
							float f33 = this.playerCtrl_Add1.hpMax / 5f;
							float f34 = Mathf.Round(f33);
							int damage7 = Mathf.RoundToInt(f34);
							this.playerCtrl_Add1.ActionDamage(damage7);
							this.playerCtrl_Add1.BloodEffect();
						}
						else if (this.playerCtrl_Add1.oldTypeArmor == 0)
						{
							...
							float num23 = this.playerCtrl_Add1.dEF / 10f;
							float num24 = enemyATK7 / 100f * this.playerCtrl_Add1.playerPOKE;
							float f35 = enemyATK7 * this.playerCtrl_Add1.berserkerMeiru - num24 - num23;
							float f36 = Mathf.Round(f35);
							int num25 = Mathf.RoundToInt(f36);
							if (num25 >= 1)
							{
								this.playerCtrl_Add1.ActionDamage(num25);
								this.playerCtrl_Add1.HitEffect();
								this.playerCtrl_Add1.BloodEffect();
							}
							else if (num25 < 1)
					...
					else if (this.playerCtrl_Add1.isSkelton)
					{
						...
						if (num26 >= 1)
						{
							this.playerCtrl_Add1.ActionDamage(num26);
							this.playerCtrl_Add1.BloodEffect();
						}
						else if (num26 < 1)
						{
				...
				else if (other.tag == "EnemyATKFire" || other.tag == "EnemyFireBullet")
				{
					if (!this.playerCtrl_Add1.isSkelton)
					{
						if (this.playerCtrl_Add1.oldTypeArmor == 1)
						{
							float f38 = this.playerCtrl_Add1.hpMax / 5f;
							float f39 = Mathf.Round(f38);
							int damage8 = Mathf.RoundToInt(f39);
							this.playerCtrl_Add1.ActionDamage(damage8);
							this.playerCtrl_Add1.FireEffect();
						}
						else if (this.playerCtrl_Add1.oldTypeArmor == 0)
						{
							EnemyBody componentInParent15 = other.GetComponentInParent<EnemyBody>();
							float enemyINT3 = componentInParent15.enemyINT;
							float num27 = this.playerCtrl_Add1.mND / 10f;
							float num28 = enemyINT3 / 100f * this.playerCtrl_Add1.playerFIRE;
							float f40 = enemyINT3 * this.playerCtrl_Add1.berserkerMeiru - num28 - num27;
							float f41 = Mathf.Round(f40);
							int num29 = Mathf.RoundToInt(f41);
							if (num29 >= 1)
							{
								this.playerCtrl_Add1.ActionDamage(num29);
								this.playerCtrl_Add1.FireEffect();
							}
							else if (num29 < 1)
							{
					...
					else if (this.playerCtrl_Add1.isSkelton)
					{
						...
						if (num30 >= 1)
						{
							this.playerCtrl_Add1.ActionDamage(num30);
							this.playerCtrl_Add1.FireEffect();
						}
						else if (num30 < 1)
						{
				...
				else if (other.tag == "EnemyATKIce")
				{
					if (!this.playerCtrl_Add1.isSkelton)
					{
						if (this.playerCtrl_Add1.oldTypeArmor == 1)
						{
							float f43 = this.playerCtrl_Add1.hpMax / 5f;
							float f44 = Mathf.Round(f43);
							int damage9 = Mathf.RoundToInt(f44);
							this.playerCtrl_Add1.ActionDamage(damage9);
							this.playerCtrl_Add1.HitEffect();
						}
						else if (this.playerCtrl_Add1.oldTypeArmor == 0)
						{
							...
							float num31 = this.playerCtrl_Add1.mND / 10f;
							float num32 = enemyINT5 / 100f * this.playerCtrl_Add1.playerICE;
							float f45 = enemyINT5 * this.playerCtrl_Add1.berserkerMeiru - num32 - num31;
							float f46 = Mathf.Round(f45);
							int num33 = Mathf.RoundToInt(f46);
							if (num33 >= 1)
							{
								this.playerCtrl_Add1.ActionDamage(num33);
								this.playerCtrl_Add1.HitEffect();
							}
							else if (num33 < 1)
							{
					...
					else if (this.playerCtrl_Add1.isSkelton)
					{
						...
						if (num34 >= 1)
						{
							this.playerCtrl_Add1.ActionDamage(num34);
							this.playerCtrl_Add1.HitEffect();
						}
						else if (num34 < 1)
						{
				...
				else if (other.tag == "EnemyATKLight")
				{
					if (!this.playerCtrl_Add1.isSkelton)
					{
						if (this.playerCtrl_Add1.oldTypeArmor == 1)
						{
							float f48 = this.playerCtrl_Add1.hpMax / 5f;
							float f49 = Mathf.Round(f48);
							int damage10 = Mathf.RoundToInt(f49);
							this.playerCtrl_Add1.ActionDamage(damage10);
							this.playerCtrl_Add1.HitEffect();
						}
						else if (this.playerCtrl_Add1.oldTypeArmor == 0)
						{
							...
							float num35 = this.playerCtrl_Add1.mND / 10f;
							float num36 = enemyINT7 / 100f * this.playerCtrl_Add1.playerLIGH;
							float f50 = enemyINT7 * this.playerCtrl_Add1.berserkerMeiru - num36 - num35;
							float f51 = Mathf.Round(f50);
							int num37 = Mathf.RoundToInt(f51);
							if (num37 >= 1)
							{
								this.playerCtrl_Add1.ActionDamage(num37);
								this.playerCtrl_Add1.HitEffect();
							}
							else if (num37 < 1)
							{
					...
					else if (this.playerCtrl_Add1.isSkelton)
					{
						...
						if (num38 >= 1)
						{
							this.playerCtrl_Add1.ActionDamage(num38);
							this.playerCtrl_Add1.HitEffect();
						}
						else if (num38 < 1)
						{
				...
				else if (other.tag == "EnemyATKDark")
				{
					if (!this.playerCtrl_Add1.isSkelton)
					{
						if (this.playerCtrl_Add1.oldTypeArmor == 1)
						{
							float f53 = this.playerCtrl_Add1.hpMax / 5f;
							float f54 = Mathf.Round(f53);
							int damage11 = Mathf.RoundToInt(f54);
							this.playerCtrl_Add1.ActionDamage(damage11);
							this.playerCtrl_Add1.HitEffect();
						}
						else if (this.playerCtrl_Add1.oldTypeArmor == 0)
						{
							...
							float num39 = this.playerCtrl_Add1.mND / 10f;
							float num40 = enemyINT9 / 100f * this.playerCtrl_Add1.playerDARK;
							float f55 = enemyINT9 * this.playerCtrl_Add1.berserkerMeiru - num40 - num39;
							float f56 = Mathf.Round(f55);
							int num41 = Mathf.RoundToInt(f56);
							if (num41 >= 1)
							{
								this.playerCtrl_Add1.ActionDamage(num41);
								this.playerCtrl_Add1.HitEffect();
							}
							else if (num41 < 1)
							{
					...
					else if (this.playerCtrl_Add1.isSkelton)
					{
						...
						if (num42 >= 1)
						{
							this.playerCtrl_Add1.ActionDamage(num42);
							this.playerCtrl_Add1.HitEffect();
						}
						else if (num42 < 1)
						{
				...
				else if (other.tag == "EnemyATKThun")
				{
					if (!this.playerCtrl_Add1.isSkelton)
					{
						if (this.playerCtrl_Add1.oldTypeArmor == 1)
						{
							float f58 = this.playerCtrl_Add1.hpMax / 5f;
							float f59 = Mathf.Round(f58);
							int damage12 = Mathf.RoundToInt(f59);
							this.playerCtrl_Add1.ActionDamage(damage12);
							this.playerCtrl_Add1.HitEffect();
						}
						else if (this.playerCtrl_Add1.oldTypeArmor == 0)
						{
							...
							float num43 = this.playerCtrl_Add1.mND / 10f;
							float num44 = enemyINT11 / 100f * this.playerCtrl_Add1.playerTHUN;
							float f60 = enemyINT11 * this.playerCtrl_Add1.berserkerMeiru - num44 - num43;
							float f61 = Mathf.Round(f60);
							int num45 = Mathf.RoundToInt(f61);
							if (num45 >= 1)
							{
								this.playerCtrl_Add1.ActionDamage(num45);
								this.playerCtrl_Add1.HitEffect();
							}
							else if (num45 < 1)
							{
					...
					else if (this.playerCtrl_Add1.isSkelton)
					{
						...
						if (num46 >= 1)
						{
							this.playerCtrl_Add1.ActionDamage(num46);
							this.playerCtrl_Add1.HitEffect();
						}
						else if (num46 < 1)
						{
				...
				else if (other.tag == "EnemyATKPoison")
				{
					...
					if (!this.playerCtrl_Add1.isSkelton)
					{
						if (this.playerCtrl_Add1.oldTypeArmor == 1)
						{
							float f63 = this.playerCtrl_Add1.hpMax / 5f;
							float f64 = Mathf.Round(f63);
							int damage13 = Mathf.RoundToInt(f64);
							this.playerCtrl_Add1.ActionDamage(damage13);
							this.playerCtrl_Add1.HitEffect();
						}
						else if (this.playerCtrl_Add1.oldTypeArmor == 0)
						{
							...
							float num47 = this.playerCtrl_Add1.mND / 10f;
							float num48 = enemyINT13 / 100f * this.playerCtrl_Add1.playerPOIS;
							float f65 = enemyINT13 * this.playerCtrl_Add1.berserkerMeiru - num48 - num47;
							float f66 = Mathf.Round(f65);
							int num49 = Mathf.RoundToInt(f66);
							if (num49 >= 1)
							{
								this.playerCtrl_Add1.ActionDamage(num49);
								this.playerCtrl_Add1.HitEffect();
							}
							else if (num49 < 1)
							{
					...
					else if (this.playerCtrl_Add1.isSkelton)
					{
						...
						if (num50 >= 1)
						{
							this.playerCtrl_Add1.ActionDamage(num50);
							this.playerCtrl_Add1.HitEffect();
						}
						else if (num50 < 1)
						{
				...
				else if (other.tag == "EnemyATKCurse")
				{
					...
					if (!this.playerCtrl_Add1.isSkelton)
					{
						if (this.playerCtrl_Add1.oldTypeArmor == 1)
						{
							float f68 = this.playerCtrl_Add1.hpMax / 5f;
							float f69 = Mathf.Round(f68);
							int damage14 = Mathf.RoundToInt(f69);
							this.playerCtrl_Add1.ActionDamage(damage14);
							this.playerCtrl_Add1.HitEffect();
						}
						else if (this.playerCtrl_Add1.oldTypeArmor == 0)
						{
							...
							float num51 = this.playerCtrl_Add1.mND / 10f;
							float num52 = enemyINT15 / 100f * this.playerCtrl_Add1.playerCURS;
							float f70 = enemyINT15 * this.playerCtrl_Add1.berserkerMeiru - num52 - num51;
							float f71 = Mathf.Round(f70);
							int num53 = Mathf.RoundToInt(f71);
							if (num53 >= 1)
							{
								this.playerCtrl_Add1.ActionDamage(num53);
								this.playerCtrl_Add1.HitEffect();
							}
							else if (num53 < 1)
							{
					...
					else if (this.playerCtrl_Add1.isSkelton)
					{
						...
						if (num54 >= 1)
						{
							this.playerCtrl_Add1.ActionDamage(num54);
							this.playerCtrl_Add1.HitEffect();
						}
						else if (num54 < 1)
						{
				...
				else if (other.tag == "EnemyATKStone")
				{
					...
					if (!this.playerCtrl_Add1.isSkelton)
					{
						if (this.playerCtrl_Add1.oldTypeArmor == 1)
						{
							float f73 = this.playerCtrl_Add1.hpMax / 5f;
							float f74 = Mathf.Round(f73);
							int damage15 = Mathf.RoundToInt(f74);
							this.playerCtrl_Add1.ActionDamage(damage15);
							this.playerCtrl_Add1.HitEffect();
						}
						else if (this.playerCtrl_Add1.oldTypeArmor == 0)
						{
							...
							float num55 = this.playerCtrl_Add1.mND / 10f;
							float num56 = enemyINT17 / 100f * this.playerCtrl_Add1.playerSTON;
							float f75 = enemyINT17 * this.playerCtrl_Add1.berserkerMeiru - num56 - num55;
							float f76 = Mathf.Round(f75);
							int num57 = Mathf.RoundToInt(f76);
							if (num57 >= 1)
							{
								this.playerCtrl_Add1.ActionDamage(num57);
								this.playerCtrl_Add1.HitEffect();
							}
							else if (num57 < 1)
							{
					...
					else if (this.playerCtrl_Add1.isSkelton)
					{
						...
						if (num58 >= 1)
						{
							this.playerCtrl_Add1.ActionDamage(num58);
							this.playerCtrl_Add1.HitEffect();
						}
						else if (num58 < 1)
						{
				...
				else if (other.tag == "EnemyATKMiryouMan")
				{
					if (!this.playerCtrl_Add1.isSkelton)
					{
						if (this.playerCtrl_Add1.oldTypeArmor == 1)
						{
							float f78 = this.playerCtrl_Add1.hpMax / 5f;
							float f79 = Mathf.Round(f78);
							int damage16 = Mathf.RoundToInt(f79);
							this.playerCtrl_Add1.ActionDamage(damage16);
							this.playerCtrl_Add1.HitEffect();
						}
						else if (this.playerCtrl_Add1.oldTypeArmor == 0)
						{
							...
							float num59 = this.playerCtrl_Add1.mND / 10f;
							float f80 = enemyINT19 * this.playerCtrl_Add1.berserkerMeiru - num59;
							float f81 = Mathf.Round(f80);
							int num60 = Mathf.RoundToInt(f81);
							if (num60 >= 1)
							{
								this.playerCtrl_Add1.ActionDamage(num60);
								this.playerCtrl_Add1.HitEffect();
							}
							else if (num60 < 1)
							{
				...
				else if (other.tag == "Trap")
				{
					if (!this.playerCtrl_Add1.isSkelton)
					{
						if (this.playerCtrl_Add1.oldTypeArmor == 1)
						{
							float f82 = this.playerCtrl_Add1.hpMax / 5f;
							float f83 = Mathf.Round(f82);
							int damage17 = Mathf.RoundToInt(f83);
							this.playerCtrl_Add1.ActionDamage(damage17);
							this.playerCtrl_Add1.BloodEffect();
						}
						else if (this.playerCtrl_Add1.oldTypeArmor == 0)
						{
							...
							float num62 = this.playerCtrl_Add1.dEF / 10f;
							float num63 = num61 / 100f * this.playerCtrl_Add1.playerCUT;
							float f84 = num61 * this.playerCtrl_Add1.berserkerMeiru - num63 - num62;
							float f85 = Mathf.Round(f84);
							int num64 = Mathf.RoundToInt(f85);
							if (num64 >= 1)
							{
								this.playerCtrl_Add1.ActionDamage(num64);
								this.playerCtrl_Add1.BloodEffect();
							}
							else if (num64 < 1)
							{
					...
					else if (this.playerCtrl_Add1.isSkelton)
					{
						...
						if (num65 >= 1)
						{
							this.playerCtrl_Add1.ActionDamage(num65);
							this.playerCtrl_Add1.BloodEffect();
						}
						else if (num65 < 1)
						{
				...
				else if (other.tag == "TrapFire")
				{
					if (!this.playerCtrl_Add1.isSkelton)
					{
						if (this.playerCtrl_Add1.oldTypeArmor == 1)
						{
							float f88 = this.playerCtrl_Add1.hpMax / 5f;
							float f89 = Mathf.Round(f88);
							int damage18 = Mathf.RoundToInt(f89);
							this.playerCtrl_Add1.ActionDamage(damage18);
							this.playerCtrl_Add1.FireEffect();
						}
						else if (this.playerCtrl_Add1.oldTypeArmor == 0)
						{
							...
							float num67 = this.playerCtrl_Add1.mND / 10f;
							float num68 = num66 / 100f * this.playerCtrl_Add1.playerFIRE;
							float f90 = num66 * this.playerCtrl_Add1.berserkerMeiru - num68 - num67;
							float f91 = Mathf.Round(f90);
							int num69 = Mathf.RoundToInt(f91);
							if (num69 >= 1)
							{
								this.playerCtrl_Add1.ActionDamage(num69);
								this.playerCtrl_Add1.FireEffect();
							}
							else if (num69 < 1)
							{
					...
					else if (this.playerCtrl_Add1.isSkelton)
					{
						...
						if (num70 >= 1)
						{
							this.playerCtrl_Add1.ActionDamage(num70);
							this.playerCtrl_Add1.FireEffect();
						}
						else if (num70 < 1)
						{
				...
				else if (other.tag == "BalowGrando")
				{
					if (this.myPV.isMine)
					{
						...
						if (this.playerCtrl_Add1 != null && this.playerCtrl_Add1.canHitIronMaiden)
						{
							this.playerCtrl_Add1.IronMaidenAction(component77.level);
						}
					}
				}
				else if (other.tag == "DraculaCatch")
				{
					if (this.myPV.isMine && this.playerCtrl_Add1 != null && this.playerCtrl_Add1.canHitIronMaiden)
					{
						...
						if (stageDifficult5 != 1)
						{
							if (stageDifficult5 != 2)
							{
								...
								{
									this.playerCtrl_Add1.IronMaidenAction(8);
								}
							}
							else
							{
								this.playerCtrl_Add1.IronMaidenAction(7);
							}
						}
						else
						{
							this.playerCtrl_Add1.IronMaidenAction(6);
						}
					}
				}
				else if (other.tag == "IronMaiden" && this.myPV.isMine)
				{
					...
					if (this.playerCtrl_Add1 != null && this.playerCtrl_Add1.canHitIronMaiden)
					{
						...
						this.playerCtrl_Add1.IronMaidenAction(component78.level);
						this.playerCtrl_Add1.gameObject.transform.position = new Vector2(component78.transform.position.x, base.transform.position.y);
					}
				}
			}
		}

		// Token: 0x06001ED3 RID: 7891 RVA: 0x00253E9C File Offset: 0x0025209C
		private void StatusPoisonRandom()
		{
			...
			if (num3 < 35)
			{
				this.playerCtrl_Add1.StatusPoison();
			}
			else
			{
				this.playerCtrl_Add1.StatusResist();
			}
		}

		// Token: 0x06001ED4 RID: 7892 RVA: 0x00253F2C File Offset: 0x0025212C
		private void StatusCurseRandom()
		{
			...
			if (num3 < 35)
			{
				this.playerCtrl_Add1.StatusCurse();
			}
			else
			{
				this.playerCtrl_Add1.StatusResist();
		...
		// Token: 0x06001ED5 RID: 7893 RVA: 0x00253FBC File Offset: 0x002521BC
		private void StatusStoneRandom()
		{
			...
			if (num3 < 35)
			{
				this.playerCtrl_Add1.StatusStone();
			}
			else
			{
				this.playerCtrl_Add1.StatusResist();
		...
		// Token: 0x06001ED6 RID: 7894 RVA: 0x00254049 File Offset: 0x00252249
		private void StatusMiryou()
		{
			this.playerCtrl_Add1.StatusMiryou();
		}

		// Token: 0x06001ED7 RID: 7895 RVA: 0x00254058 File Offset: 0x00252258
		...
		private PlayerController_Add1 playerCtrl_Add1;
